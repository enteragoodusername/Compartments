...
const CompartmentForm = ({comparts, setComparts}) =>{
  ...
  return (
    <form className='module compartForm' onSubmit={addComparts}>
      ...
      <button type='submit' value="Submit" className='bg-lime-500 pl-2 pr-2 pt-1 pb-1 ml-2 border rounded'>
        SUBMIT
        </button>
    </form>
  );
...
const TaskForm = ({ comparts, setComparts}) => {
  ...
  return (
    <form className='module taskForm ' onSubmit={addTasks}>
      ...
      <br/>
      <button type='submit' value="Add Task" className='bg-lime-500 pl-2 pr-2 pt-1 pb-1 border rounded'> 
        SUBMIT
      </button>
    </form>
  )
...
export {Header, TaskForm, CompartmentForm, Compartment, Task };